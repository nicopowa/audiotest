 ...
 * AUDIOTEST PACKAGE RELEASE v0.0.6
 * 08/01/2025 03:07:56
 */
(function(){
...
function A(a){w(function(b){switch(b.g){case 1:return a.h=new (window.AudioContext||window.webkitAudioContext)({}),k(b,B(a),2);case 2:return C(a),b.j=3,k(b,D(a),5);case 5:b.g=4;b.j=0;break;case 3:m(b),a.J=!1;case 4:return E(a),a.i=a.h.createGain(),a.T=a.h.createMediaElementSource(a.g),a.D=a.h.createGain(),a.D.gain.value=.2,a.C=a.h.createOscillator(),a.C.type="sine",a.C.frequency.value=440,a.C.connect(a.D),a.C.start(0),F(a),a.T.connect(a.i),a.J&&a.i.connect(a.u.h),a.i.connect(a.R),G(a),k(b,H(a),6);
case 6:a.P=function(){return a.Y.bind(a)()},I(a),b.g=0}})}function B(a){return w(function(b){return k(b,a.h.resume(),0)})}
